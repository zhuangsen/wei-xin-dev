...
public class WeixinTest {
	public static void main(String[] args) {
		try {
			...
			// String imageMediaId =
			// WeixinUtil.upload(imagePath,WeixinUtil.UPLOAD_IMG_URL,
			// WeixinUtil.ACCESS_TOKEN, "image");
			// System.out.println("imageMediaId：");
			// System.out.println(imageMediaId);
			// String thumbMediaId =
			// WeixinUtil.upload(imagePath,WeixinUtil.UPLOAD_IMG_URL,
			// WeixinUtil.ACCESS_TOKEN, "thumb");
			// System.out.println("thumbMediaId：");
			// System.out.println(thumbMediaId);
			// String voiceMediaId =
			// WeixinUtil.upload(voicePath,WeixinUtil.UPLOAD_IMG_URL,
			// WeixinUtil.ACCESS_TOKEN, "voice");
			// System.out.println("voiceMediaId：");
			// System.out.println(voiceMediaId);
			// String videoMediaId =
			// WeixinUtil.upload(videoPath,WeixinUtil.UPLOAD_IMG_URL,
			// WeixinUtil.ACCESS_TOKEN, "video");
			// System.out.println("videoMediaId：");
			// System.out.println(videoMediaId);

			// 上传永久素材
			// 永久图片素材
			// WeixinUtil.upload(imagePath, WeixinUtil.ADD_MATERIAL_URL,
			// "image");
			// 永久缩略图素材
			// String eternalthumbMediaId =
			// WeixinUtil.upload(thumbPaht,WeixinUtil.ADD_MATERIAL_URL,
			// WeixinUtil.ACCESS_TOKEN, "thumb");
			// 永久语音素材
			// String eternalVoiceMediaId =
			// WeixinUtil.upload(voicePath,WeixinUtil.ADD_MATERIAL_URL,
			// WeixinUtil.ACCESS_TOKEN, "voice");
			// 永久视频素材
			// String eternalVideoMediaId =
			// WeixinUtil.upload(videoPath,WeixinUtil.ADD_MATERIAL_URL,
			// WeixinUtil.ACCESS_TOKEN, "video");
			// 永久图文素材
			// JSONObject eternalNews =
			// WeixinUtil.uploadArticle(WeixinUtil.ACCESS_TOKEN);
...
//			System.out.println(jsonObject.toString());
			...
			// JSONObject jsonObject =
			// WeixinUtil.deleteMenu(WeixinUtil.ACCESS_TOKEN);
			// System.out.println(jsonObject.toString());
